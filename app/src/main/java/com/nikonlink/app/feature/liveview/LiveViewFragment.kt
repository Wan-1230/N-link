...
import com.nikonlink.app.feature.remote.ShootingState
import com.nikonlink.app.feature.remote.RemoteShootingViewModel
...
class LiveViewFragment : Fragment() {
    ...
    private fun toggleControls() {
        if (controlsVisible) {
            ...
            fadeOut(binding.btnDisp, binding.rightControls)
    ...
    private fun showControls() {
        ...
        fadeIn(binding.btnDisp, binding.rightControls)
        binding.viewGridOverlay.visibility = if (gridVisible) View.VISIBLE else View.GONE
    }
